...
@Component({
  selector: 'app-tpython',
  templateUrl: './tpython.component.html',
  styleUrls: ['./tpython.component.css']
})
export class TpythonComponent implements OnInit {
  ...
  checkAnswer() {
    ...
    this.dataservice.check(reqdata).subscribe((res) => {
      ...
      if (this.Response.includes('error:')) {
        ...
        this.rightans = this.testScore / 2
